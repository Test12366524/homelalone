...
const FaqPage = () => {
  ...
  const groupedFaqs: {
  ...
  }[] = [
    {
      ...
      items: [
        {
          question: "Apakah produk NESTAR aman untuk semua jenis kulit?",
          answer:
            "Ya, seluruh produk NESTAR diformulasikan dengan bahan-bahan berkualitas tinggi, dermatologically tested, dan aman untuk semua jenis kulit, termasuk kulit sensitif. Namun, kami tetap menyarankan untuk melakukan patch test sebelum pemakaian rutin.",
        },
        {
          question: "Apakah produk NESTAR sudah terdaftar di BPOM?",
          answer:
            "Benar, semua produk NESTAR telah mendapatkan izin edar resmi dari BPOM sehingga terjamin aman digunakan.",
        },
        {
          question: "Apakah NESTAR menggunakan bahan alami?",
          answer:
    ...
    },
    {
      ...
      items: [
        {
          question:
            "Apakah produk NESTAR bisa dipakai oleh ibu hamil dan menyusui?",
          answer:
            "Sebagian besar produk NESTAR aman digunakan oleh ibu hamil dan menyusui. Namun, untuk produk dengan kandungan tertentu seperti retinol, sebaiknya dikonsultasikan dengan dokter terlebih dahulu.",
        },
        {
          question: "Apakah bisa digabung dengan skincare lain?",
          answer:
            "Ya, produk NESTAR dapat dikombinasikan dengan skincare lain. Kami menyarankan untuk mengikuti urutan basic skincare: cleansing → toner → serum → moisturizer → sunscreen.",
        },
        {
          question:
    ...
    },
    {
      ...
      items: [
        {
          question: "Berapa lama pengiriman produk NESTAR?",
          answer:
    ...
    },
    {
      ...
      items: [
        ...
        {
          question: "Apakah aman berbelanja di website NESTAR?",
          answer:
    ...
    },
    {
      ...
      items: [
        {
          question: "Apakah ada program loyalitas NESTAR?",
          answer:
            "Ya! Bergabunglah dengan NESTAR Club untuk mengumpulkan poin dari setiap transaksi. Poin bisa ditukar dengan diskon, voucher, atau produk eksklusif.",
        },
        {
          question: "Apakah ada promo khusus untuk pelanggan baru?",
          answer:
            "Pelanggan baru mendapatkan diskon 10% untuk pembelian pertama dengan kode voucher WELCOMENESTAR.",
        },
        {
      ...
      <section className="pt-24 pb-6 px-6 lg:px-12">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
            ...
            berbelanja bersama{" "}
            <span className="text-[#E53935] font-semibold">NESTAR</span>.
          </p>
        </div>
      </section>
